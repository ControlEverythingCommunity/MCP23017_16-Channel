...
void loop()
{
  ...
  for (int i = 0; i < 8; i++)
  {
    ...
    Particle.publish("Enabling Pull-up on GPIO pin", String(i) + " of Port-A");
    data = data << 1;
    data = data + 1;
    delay(1000);
  }
  ...
  for (int i = 0; i < 8; i++)
  {
    ...
    // Output data to dashboard
    Particle.publish("Enabling Pull-up on GPIO pin", String(i) + " of Port-B");
    data = data << 1;
    data = data + 1;
    delay(1000);
  }
  ...
  for (int i = 0; i < 8; i++)
  {
    ...
    // Output data to dashboard
    Particle.publish("Disabling Pull-up on GPIO pin", String(i) + " of Port-A");
    data = data << 1;
    delay(1000);
  }
  ...
  for (int i = 0; i < 8; i++)
  {
    ...
    // Output data to dashboard
    Particle.publish("Disabling Pull-up on GPIO pin", String(i) + " of Port-B");
    data = data << 1;
    delay(1000);
  }
}
